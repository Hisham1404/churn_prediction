...
def predict():
    ...
    df_2 = pd.get_dummies(df_2, columns=['gender', 'Partner', 'Dependents', 'PhoneService', 'MultipleLines', 'InternetService',
                                         'OnlineSecurity', 'OnlineBackup', 'DeviceProtection', 'TechSupport',
                                         'StreamingTV', 'StreamingMovies', 'Contract', 'PaperlessBilling',
    ...
    probablity = model.predict_proba(new_df.tail(1))[:,1]
    ...
    chat_input = "use the inputs to help the telecom industry to improve the customer satisfaction ".join([inputQuery1, inputQuery2, inputQuery3, inputQuery4, inputQuery5, inputQuery6, inputQuery7, 
                           inputQuery8, inputQuery9, inputQuery10, inputQuery11, inputQuery12, inputQuery13, inputQuery14,
                           inputQuery15, inputQuery16, inputQuery17, inputQuery18, inputQuery19])
    chat_response = chat(chat_input)

    return render_template('home.html', output1=o1, output2=o2, chat_response=chat_response,
